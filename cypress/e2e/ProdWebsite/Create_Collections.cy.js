...
describe('Creating the Collections', () => {
    ...
    // cy.visit ('https://pro.shopdeck.com/website/collection/create-collection')
      ...
      cy.contains("Select Products").click();
        ...
        cy.get(':nth-child(1) > .CatalogueSelectorCard_card-wrapper__GF4rc > .Button_button-primary__9i0Rz').click();
        cy.get(':nth-child(2) > .CatalogueSelectorCard_card-wrapper__GF4rc > .Button_button-primary__9i0Rz').click();
        cy.get(':nth-child(3) > .CatalogueSelectorCard_card-wrapper__GF4rc > .Button_button-primary__9i0Rz').click();
