...
cy.get(':nth-child(1) > .Flexbox_flex-column__cNkZ2 > .rs-flex-box-grid-item-24 > .rs-picker > .rs-picker-toggle > .rs-stack > [style="flex-grow: 1; overflow: hidden;"] > .rs-picker-toggle-textbox').click().type("2024-01-10 12:00:00");
